...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String accompanimentPriceAndroidStringAmountOrderViewModelAccompanimentPrice = null;
        java.lang.String orderViewModelTaxGetValue = null;
        double orderViewModelEntreePrice = 0.0;
        com.example.lunchtray.model.OrderViewModel orderViewModel = mOrderViewModel;
        java.lang.String entreePriceAndroidStringAmountOrderViewModelEntreePrice = null;
        ...
        java.lang.String sidePriceAndroidStringAmountOrderViewModelSidePrice = null;
        double orderViewModelAccompanimentPrice = 0.0;
        androidx.lifecycle.LiveData<com.example.lunchtray.model.MenuItem> orderViewModelEntree = null;
        double orderViewModelSidePrice = 0.0;
        ...
        if ((dirtyFlags & 0x17fL) != 0) {
            ...
            if ((dirtyFlags & 0x141L) != 0) {
                    ...
                    if (orderViewModelAccompanimentGetValue != null) {
                        ...
                        // read orderViewModel.accompaniment.getValue().price
                        orderViewModelAccompanimentPrice = orderViewModelAccompanimentGetValue.getPrice();
                    }


                    // read @android:string/amount
                    accompanimentPriceAndroidStringAmountOrderViewModelAccompanimentPrice = accompanimentPrice.getResources().getString(R.string.amount, orderViewModelAccompanimentPrice);
            }
            ...
            if ((dirtyFlags & 0x144L) != 0) {
                    ...
                    if (orderViewModelSideGetValue != null) {
                        ...
                        // read orderViewModel.side.getValue().price
                        orderViewModelSidePrice = orderViewModelSideGetValue.getPrice();
                    }


                    // read @android:string/amount
                    sidePriceAndroidStringAmountOrderViewModelSidePrice = sidePrice.getResources().getString(R.string.amount, orderViewModelSidePrice);
            }
            ...
            if ((dirtyFlags & 0x160L) != 0) {
                    ...
                    if (orderViewModelEntreeGetValue != null) {
                        ...
                        // read orderViewModel.entree.getValue().price
                        orderViewModelEntreePrice = orderViewModelEntreeGetValue.getPrice();
                    }


                    // read @android:string/amount
                    entreePriceAndroidStringAmountOrderViewModelEntreePrice = entreePrice.getResources().getString(R.string.amount, orderViewModelEntreePrice);
            }
        }
        // batch finished
        if ((dirtyFlags & 0x141L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.accompanimentPrice, accompanimentPriceAndroidStringAmountOrderViewModelAccompanimentPrice);
        ...
        if ((dirtyFlags & 0x160L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreePrice, entreePriceAndroidStringAmountOrderViewModelEntreePrice);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreeSelection, orderViewModelEntreeName);
        }
        if ((dirtyFlags & 0x144L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.sidePrice, sidePriceAndroidStringAmountOrderViewModelSidePrice);
